      ...
      <div className="mx-auto max-w-6xl">
        <Reveal>
          ...
          <p className="text-muted max-w-2xl mb-10">
            A few of the things I&apos;ve built. Swap the placeholders below for your own
            case studies — real projects with a short story convert far better than generic cards.
          </p>
        </Reveal>
              ...
              >
                <div className="flex items-start justify-between gap-2 mb-3">
                  ...
                  {p.placeholder ? (
                    ...
                    <ArrowUpRight
                      size={18}
                      className="text-muted group-hover:text-accent-2 group-hover:rotate-45 transition-transform shrink-0"
                    />
                  )}
                </div>
